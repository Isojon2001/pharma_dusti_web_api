...
function RegistrationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://api.dustipharma.tj:1212/api/v1/app/auth/forget-password', {
        phone: cleanedPhone,
      });
      ...
      navigate('/setPassword');
        ...
        setModalMessage('Номер не найден');
        setShowModal(true);
    }
  };
    ...
    <div className="registration gap">
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal">
            <h2>{modalMessage}</h2>
            <h2>Обратитесь в тех поддержку Дусти фарма</h2>
            <div className="user-modal__field field">
