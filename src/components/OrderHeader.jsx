...
function OrderHeader() {
  ...
  return (
    <div className="AddProductsToСart my_orders_bg">
          ...
          {isHoverings && (
            ...
            >
              <div className="user-modal__field">
                <button className="user-modal__links" onClick={() => window.location.href = './my-warehouse'}>
                  Мой склад
                </button>
              </div>

              <div className="user-modal__field">
                <button className="user-modal__links" onClick={() => window.location.href = './my-orders'}>
                  Мои заказы
                </button>
              </div>
                            <div className="user-modal__field">
                <button className="user-modal__links" onClick={() => window.location.href = './my-statistic'}>
                  Статистика
                </button>
              </div>
              <div className="user-modal__field">
                <button className="user-modal__links" onClick={() => window.location.href = './paymants-client'}>
                  Мои финансы
                </button>
              </div>
              <div className="user-modal__field">
                <button className="user-modal__links" onClick={() => window.location.href = './Reporting'}>
                  Отчетность
                </button>
              </div>
                            <div className="user-modal__field">
